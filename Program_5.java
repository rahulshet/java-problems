/* Q5.] Insert n random integers into the file Integers.txt .
 * Create 3 threads T1, T2, T3 and read n/3 integers and sort the numbers.
 * T4 waits for all threads to complete sorting and sorts the whole list and
 * stores sorted list in SortedIntegers.txt
*/
import java.nio.*;
